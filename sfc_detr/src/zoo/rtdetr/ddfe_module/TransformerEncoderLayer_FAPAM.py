...
class TransformerEncoderLayer_FAPAM(nn.Module):
    def __init__(self, c1, cm=2048, dropout=0.0, act=nn.GELU(), normalize_before=False):
        super().__init__()
...
class FFN(nn.Module):
    def __init__(self,in_features, hidden_features=None, out_features=None, window_size=4, act_layer=nn.GELU) -> None:
        ...
        self.fm = AdaptiveWindowFrequencyModulation(out_features, window_size)
