...
class SetCriterion(nn.Module):
    ...
    def loss_boxes(self, outputs, targets, indices, num_boxes):
        ...
        # loss_giou = 2.0 - torch.diag(interpiou(box_cxcywh_to_xyxy(src_boxes), box_cxcywh_to_xyxy(target_boxes)))
        # loss_giou = 1.0 - bbox_iou1(src_boxes, target_boxes,xywh=True,SIoU=True)
